...
<span id="gotovideo"></span>
<?php
$detect = new Mobile_Detect;

$video_file = '/video/animation-new-des.mp4';
$video_attributes = ' loop preload="auto" autoplay autobuffer muted';
...
if($detect->isMobile()){
    $video_file = '/video/animation-new-mob.m4v';
    $video_attributes = ' controls preload="auto" autoplay autobuffer muted';
...
<!--<canvas width="634" height="264"></canvas>-->
    <video width="634" height="264" id="presentation-video"  <?php echo $video_attributes;?> <?php echo $playsinline;?>>
...
<script>
    ...
    $(function() {
        ...
        // $('video#presentation-video').width(vnw);
        $('video#presentation-video').height(vnh);

        // var vid = document.getElementById("presentation-video");
        // vid.play();
