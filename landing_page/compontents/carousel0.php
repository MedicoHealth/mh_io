...
<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
    <h2 class="display-4">Ico ratings</h2>
    <p>We scored big</p>
</div>
...
<div class="showMobile" style="text-align:center">
  ...
  <a data-toggle="collapse" data-target="#teamMember<?php echo $key; ?>" class="showMobile" href id="teamClick<?php echo $key; ?>" onclick="hide('teamClick<?php echo $key; ?>')">Read more »</a>
</div>
...
<div id="carouselExampleIndicators" class="carousel slide showMobile" data-ride="carousel">
  <?php
    $topIcoReviewsDouble = array(
      array($topIcoReviews[0],$topIcoReviews[1]),
      array($topIcoReviews[2],$topIcoReviews[3]),
      array($topIcoReviews[4],$topIcoReviews[5]),
    );
  ?>
