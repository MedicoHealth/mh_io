...
try {
    ...
    //Recipients
    $mail->setFrom('info@medicohealth.io', 'Medicohealth WHITEPAPER');
    ...
    $mail->Body    = "Hi!
<br>
Thank you for showing an interest in supporting us.
<br>
Please find attached the whitepaper beta and lightpaper. If you have any questions, don't hesitate to contact us.
<br><br>
Best regards,<br>
Medicohealth Team";
