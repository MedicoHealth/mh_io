<div class="row featurette featuretteText featuretteHeight" style=" height: 100%; ">
  <div class="order-1 order-lg-2 col-lg-6 col-xl-5 left-right-text rightText">
    <h2 class="featurette-heading"><span class="text-muted">Connect</span> all parties and <span class="text-muted">improve</span> fragmented <span class="text-muted">healthcare</span></h2>
    <p>
It hurts to see how wounded and crippled our current system is. There is pain on both sides and suffering seems to be inevitable. It’s time to bring all parties together to one table, to stop fighting each other and finally start to work together. For the greater cause. Not for the money. That’s our vision.
  ...
  <div class="order-2 order-lg-1 col-lg-6 col-xl-7">
    <div class="frameLeft"><img class="featurette-image mx-auto"
       data-src="holder.js/500x500/auto" alt="500x500" src="<?php echo $root ?>/supporters/img/slike/a2.png" data-holder-rendered="true" ></div>
  </div>
</div>
