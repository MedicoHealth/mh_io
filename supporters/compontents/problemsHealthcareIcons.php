...
$problemsData = array (
    ...
    "text"=>"Due to incorrect information or information from unreliable sources"),
    array( "title" =>"Unverified medical information",
    "text"=>"It is hard to find verified medical information on the internet"),
    ...
    "text"=>"No real control over sensible and private information"),
